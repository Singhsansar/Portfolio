...
const Skills = () => {
  return (
    <section
      id="skills"
      className="relative w-auto py-20 border-b-[1px] text-white border-b-black mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16 overflow-hidden"
    >
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4 mt-12 justify-items-center">
        {[
          ...
          <div key={index} className="flex flex-col items-center">
            <skill.icon
              className={`text-4xl sm:text-5xl ${skill.color} transform hover:scale-110 transition duration-300 ease-in-out`}
            />
